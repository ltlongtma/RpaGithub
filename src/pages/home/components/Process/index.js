...
const RpaProcess = ({ viewMobile }) => {
  return (
    ...
    {/* Title */}
      ...
      {/* Mobile view */}
      <div className={cx("h-100")} style={{ display: viewMobile ? "block" : "none" }}>
        <Swiper
          slidesPerView={1.3}
          spaceBetween={15}
          pagination={{
          ...
          className={cx("slide")}
        >
          <SwiperSlide className={cx("d-flex flex-column justify-content-center ms-3 w-75 ")}>
          ...
          <SwiperSlide className={cx("d-flex flex-column justify-content-center  w-75 ")}>
