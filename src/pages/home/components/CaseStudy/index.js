...
export default function CaseStudy({ viewMobile }) {
  ...
  return (
    <div className={cx("container")}>
      ...
      <div
        className={cx("body")}
        style={{ display: viewMobile ? "none" : "block" }}
      >
        <Box sx={{ width: "100%" }}>
      ...
      <div
        className={cx("body")}
        style={{ display: viewMobile ? "block" : "none" }}
      >
        <div>
          <Button
            startIcon={<Image src={tab1} alt="imgTab1" />}
            endIcon={
              openCase1 ? <KeyboardArrowDownIcon /> : <KeyboardArrowRightIcon />
            }
          ...
          <Button
            ...
            endIcon={
              openCase2 ? <KeyboardArrowDownIcon /> : <KeyboardArrowRightIcon />
            }
          ...
          <Button
            ...
            endIcon={
              openCase3 ? <KeyboardArrowDownIcon /> : <KeyboardArrowRightIcon />
            }
          ...
          <Button
            ...
            endIcon={
              openCase4 ? <KeyboardArrowDownIcon /> : <KeyboardArrowRightIcon />
            }
          ...
          <Button
            ...
            endIcon={
              openCase5 ? <KeyboardArrowDownIcon /> : <KeyboardArrowRightIcon />
            }
